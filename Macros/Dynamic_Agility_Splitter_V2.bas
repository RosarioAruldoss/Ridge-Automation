...
Sub Dynamic_Account_Splitting()
    ...
    For r = 2 To UBound(dataArr, 1)
        ...
        If allocDict.Exists(key) Then
            ...
            For i = 1 To allocRows.Count
                ...
                ' Step 1: clone original row
                For c = 1 To UBound(dataArr, 2)
                    outArr(outRow, c) = dataArr(r, c)
                Next c
                
                ' Step 2: split numeric columns
        ...
        Else
            ' No matching allocation found, keep original row once
            For c = 1 To UBound(dataArr, 2)
                outArr(outRow, c) = dataArr(r, c)
            Next c
            outRow = outRow + 1
    ...
    MsgBox "Dynamic account splitting completed successfully.", vbInformation
...
' value = Collection of relative column positions
'========================================================
...
' Used for Merch / Exec / Sup mapping in your implemented layout
'========================================================
