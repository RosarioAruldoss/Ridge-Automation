...
Sub ExtractSmartMappedData()
    ...
    headers = Array("Zone", "ITEM", "ITMDSC", "SUPPLR", "QTY", "PP", "SP", "GV", "Net SP")
    ...
    For i = 2 To lastRow
        With wsTo
            ...
            .Cells(i, 3).Value = GetCell(wsFrom, i, colMap("ITEM"))       ' Customer Article
            .Cells(i, 4).Value = GetCell(wsFrom, i, colMap("ITMDSC"))     ' Item Description
            .Cells(i, 5).Value = GetCell(wsFrom, i, colMap("SUPPLR"))     ' Model (from SUPPLR)
            ...
            .Cells(i, 8).Value = GetCell(wsFrom, i, colMap("PP"))         ' PP
            .Cells(i, 9).Value = GetCell(wsFrom, i, colMap("SP"))         ' SP
            .Cells(i, 10).Value = GetCell(wsFrom, i, colMap("GV"))        ' GV (optional)
            .Cells(i, 11).Value = GetCell(wsFrom, i, colMap("Net SP"))    ' Net SP (optional)
        End With
    Next i
